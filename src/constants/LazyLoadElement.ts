...
export const AddNewTeacherPageLazyLoadElement = lazy(() => import("../features/admin/pages/AddNewTeacherPage"));
...
export const StartedCoursesPageLazyLoadElement = lazy(() => import("../features/admin/pages/StartedCoursesPage"));
